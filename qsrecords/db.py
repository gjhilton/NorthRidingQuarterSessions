...
def init_db(db_path: Path) -> None:
    ...
    # Pre-populate the canonical offence_type vocabulary with is_seeded=True,
    # so an LLM-returned match (e.g. "drunkenness") lands on the seeded row
    # instead of silently creating a fresh is_seeded=False duplicate the

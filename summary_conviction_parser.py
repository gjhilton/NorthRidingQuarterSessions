...
ADDITIONAL_PERSON_NAMES= [
    ...
    "Johnson Cross",
    "John Day",
    "John Cleming Grenfell",
    "John Clemming Grenfell",
    "John Thomas Saunderson",
    "John Lythe",
    "Johnson Hutton",
    ...
    "Sampson Storm",
    "Shaddrack Hind",
    "Shaftoe Pearson Richardson",
    "Shafto Pearson Richardson",
    "Smart Newton",
    "Susannah Skelly",
    "Thomas Byron",
    "Thomas Connelly",
